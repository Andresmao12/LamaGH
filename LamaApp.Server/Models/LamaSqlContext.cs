    ...
    public partial class LamaSqlContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Evento>(entity =>
            {
                ...
                entity.HasOne(d => d.IdCapituloNavigation).WithMany(p => p.Eventos)
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasOne(d => d.Capitulo).WithMany(p => p.Usuarios).HasForeignKey(d => d.IdCapitulo);
                entity.HasOne(d => d.Contacto).WithOne(p => p.Usuario).HasForeignKey<Usuario>(d => d.IdContacto);
                entity.HasOne(d => d.Motocicleta).WithOne(p => p.Usuario).HasForeignKey<Usuario>(d => d.IdMotocicleta);
                entity.HasOne(d => d.Pareja).WithOne(p => p.Usuario).HasForeignKey<Usuario>(d => d.IdPareja);
            });
